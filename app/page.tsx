...
export default function BrixsportsWaitlist() {
  ...
  useEffect(() => {
    ...
    // Capture referral source from URL parameters
    const urlParams = new URLSearchParams(window.location.search)
    const ref = urlParams.get('ref') || urlParams.get('source') || document.referrer || "direct"
              ...
              <div className="mb-6 md:mb-8 space-y-4 md:space-y-6">
                <div className="space-y-6">
                  ...
                  <a 
                    ...
                    className="block bg-gradient-to-r from-green-600/30 to-green-800/30 rounded-xl p-4 border-2 border-green-400/50 hover:from-green-600/40 hover:to-green-800/40 transition-all duration-300 hover:scale-[1.02] cursor-pointer"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg sm:text-xl font-black text-white">Join Our WhatsApp Community!</h3>
                        <p className="text-green-200 text-sm sm:text-base font-semibold">Connect with other sports enthusiasts</p>
                      </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 max-w-2xl mx-auto">
                <a
                  href="https://snapchat.com/add/brixsports?ref=social_media&utm_source=brixsports&utm_medium=social&utm_campaign=community&utm_content=snapchat"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://instagram.com/brixsports?ref=social_media&utm_source=brixsports&utm_medium=social&utm_campaign=community&utm_content=instagram"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://tiktok.com/@brixsports?ref=social_media&utm_source=brixsports&utm_medium=social&utm_campaign=community&utm_content=tiktok"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://x.com/brixsports?ref=social_media&utm_source=brixsports&utm_medium=social&utm_campaign=community&utm_content=twitter"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://chat.whatsapp.com/G7NDG2rASDx29LZaKlQjVK?mode=ems_wa_t&ref=whatsapp_community&utm_source=brixsports&utm_medium=social&utm_campaign=community&utm_content=whatsapp"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="mailto:brixsports2025@gmail.com?ref=social_media&utm_source=brixsports&utm_medium=email&utm_campaign=community&utm_content=email"
